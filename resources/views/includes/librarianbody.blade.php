                ...
                <div class="row">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-3 text-center">
                                <div class="row">
                                    <button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-success main" id="bookmember-btn">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6 text-center">
                            <button type="button" onclick="window.location.href='{{ url('/studentRegistration') }}'" class="btn btn-default main" id="bookmember-btn">Register Students</button>
                        </div>
                        <div class="col-md-6 text-center">
                            <button type="button" onclick="window.location.href='{{ url('/memberRegister') }}'" class="btn btn-default main" id="bookmember-btn">Register Academic Staff</button>
                        </div>
                    </div>
                </div>

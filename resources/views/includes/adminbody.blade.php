                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="col-md-3 text-center">
                                <div class="row">
                                    <button type="button" class="btn btn-success main" id="admintasks-btn">
                                        <img src="icons/eventlog.png" width="150" />
                                    </button>
                                </div> 
                                <br/>
                            </div>
                            <div class="col-md-3 text-center">
                                <div class="row">
                                    <button type="button" class="btn btn-success main" id="admintasks-btn">
                                        <img src="icons/purchaserequests.png" width="150" />
                                    </button>
                                </div> 
                                <br/>
                            </div>
                            <div class="col-md-3 text-center">
                                <div class="row">
                                    <button type="button" class="btn btn-success main" id="admintasks-btn">
                                        <img src="icons/inventorycheck.png" width="150" />
                                    </button>
                                </div> 
                                <br/>
                            </div>
                            <div class="col-md-3 text-center">
                                <div class="row">
                                    <button type="button" onclick="window.location.href='{{ route('userregister') }}'" class="btn btn-success main" id="admintasks-btn">
                                        <img src="icons/adduser.png" width="150" />
                                    </button>
                                </div> 
                                <br/>
                            </div>
